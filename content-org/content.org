...
** DONE Org-mode 导出中文 PDF                                                   :@Post:emacs:latex:pdf:
   ...
   :EXPORT_HUGO_CUSTOM_FRONT_MATTER: :toc true
   :EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :featured_image /images/featured/orgmode-to-pdf.png
   :END:
...
** DONE 使用 docker 部署一个生产环境可用的 ELK 集群                             :@Post:elasticsearch:docker:tls:
   ...
   :EXPORT_HUGO_CUSTOM_FRONT_MATTER: :toc true
   :EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :featured_image /images/featured/elasticsearch-logo.png
   :END:
